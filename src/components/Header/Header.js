      ...
      <div className="flex flex-wrap items-center justify-between max-w-screen-xl p-4 mx-auto">
        ...
        <div className="flex items-center space-x-4 md:order-2">
          ...
          {/* <button
            ...
            className="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-gray-900 rounded-lg cursor-pointer dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white"
            onClick={toggleLanguage}
          >
            <svg
